                    ...
                    return (
                        <div className='flex gap-1 justify-center'>
                            {Array.from(Array(columns).keys()).map((column, index) => {
                                ...
                                return (seat * columns + column + 1 <= totalSeats && (
    ...
    return (
        show && <div>
            ...
            <div className='flex justify-between card p-2 items-center'>
                ...
                <div>
                    <h1 className='text-xl'>
                        {moment(show.time).format("MMM Do yyyy")}
            ...
            {selectedSeats.length > 0 && <div className='mt-2 flex justify-center'>
                ...
                billingAddress
                stripeKey="pk_test_51RKsgrPEAwvRQKq1Qr0rFJXvWHvDi11eYM3i4Tt7XEcHSn21sLsRkYxnMjjDkNW6PLoY7CGGn6jv6TbFrVHd7jLm00RZeUhrGB"
                >
